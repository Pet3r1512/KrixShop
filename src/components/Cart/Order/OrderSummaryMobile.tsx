...
export default function OrderSummaryMobile({
  ...
  return (
    <Drawer>
      <DrawerTrigger className="lg:hidden bg-primary text-white rounded-xl text-xl px-4 pb-3 pt-2.5 absolute bottom-0 left-1/2 -translate-x-1/2">
        Next Step
      </DrawerTrigger>
