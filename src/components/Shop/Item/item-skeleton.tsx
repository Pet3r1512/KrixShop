...
export default function ItemSkeleton() {
  return (
    <section className="lg:my-16 my-8 md:flex md:flex-row md:gap-x-2.5 lg:gap-x-24 px-4 lg:px-0">
      <Skeleton className="h-[250px] md:h-[350px] w-auto md:w-2/5 lg:w-2/5 lg:h-[600px] mx-auto lg:mx-0 "></Skeleton>
