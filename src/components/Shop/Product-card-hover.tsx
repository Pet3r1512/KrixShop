...
export default function ProductCardHover({ quantity }: { quantity: number }) {
  return (
    <div className="absolute hidden bg-transparent lg:group-hover:flex lg:w-64 w-24 md:w-32 h-full flex-col justify-between py-4 px-2.5 z-10">
      ...
      <button
        disabled={quantity < 1}
        className={`px-3.5 py-2 rounded-xl bg-white border-2 border-primary text-primary font-medium ${
          quantity >= 1 &&
